...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backends = __webpack_require__(218);

	var _backends2 = _interopRequireDefault(_backends);

	var _frontends = __webpack_require__(222);

	var _frontends2 = _interopRequireDefault(_frontends);

	var _developers = __webpack_require__(223);
		...
		_createClass(Backends, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_list2.default, { listado: _backends }),
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: '/' },
						'Welcome'
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                this.props.listado.map(function (empleado) {
	                    ...
	                    return _react2.default.createElement(_row2.default, { key: empleado.id,
	                        name: empleado.name,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _avatar = __webpack_require__(221);
		...
		_createClass(Row, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'li',
					{ className: 'media' },
					_react2.default.createElement(_avatar2.default, { picture: this.props.picture }),
					_react2.default.createElement(
						'div',
		...
		_createClass(Avatar, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement("img", { className: "media-object", width: "64px", src: "public/img/" + this.props.picture })
				);
			}
		}]);
		...
		_createClass(Frontends, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_list2.default, { listado: _frontends }),
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: '/' },
						'Welcome'
		...
		_createClass(Developers, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_list2.default, { listado: _developers }),
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: '/' },
						'Welcome'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBeforeUnload2 = __webpack_require__(245);

	var _useBeforeUnload3 = _interopRequireDefault(_useBeforeUnload2);

	exports.useBeforeUnload = _useBeforeUnload3['default'];

	var _useQueries2 = __webpack_require__(246);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBeforeUnload = __webpack_require__(245);
